...
- 41e4b8d: Add native GitHub merge-queue orchestration for parallel agent work: durable queued/ejected lifecycle state, branch-rule-derived required checks, queue-aware monitoring and reconciliation, bounded batch admission, and deterministic merge-group bisection. Move mutation testing out of the release gate and add merge-group-compatible PR CI plus reproducible repository rules.

### Patch Changes

- Updated dependencies [41e4b8d]
  - @cat-cave/qdcli-core@0.4.0
...
- Updated dependencies [841f3ba]
  - @cat-cave/qdcli-core@0.2.1
...
- Updated dependencies [d1f71a5]
  - @cat-cave/qdcli-core@0.2.0
